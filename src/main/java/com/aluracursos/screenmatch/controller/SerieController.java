...
public class SerieController {
    ...
    public List<EpisodioDTO> obtenerTemporadaPorId(@PathVariable Long id, @PathVariable Long numeroTemporada){
    ...
    public List<SerieDTO> obtenerSeriePorCategoria(@PathVariable String nombreGenero){
        return servicio.obtenerSerioPorCategoria(nombreGenero);
    }
}
